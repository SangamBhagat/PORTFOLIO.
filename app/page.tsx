...
const projects = [
  ...
  { title: "Artificial Intelligence", description: "A future project exploring intelligent systems, automation, and AI-powered ideas." },
...
const techStack = [
  { name: "HTML5", icon: iconUrl("html5") }, { name: "CSS3", icon: iconUrl("css3") }, { name: "JavaScript", icon: iconUrl("javascript") }, { name: "TypeScript", icon: iconUrl("typescript") }, { name: "Python", icon: iconUrl("python") }, { name: "React", icon: iconUrl("react") }, { name: "C++", icon: iconUrl("cplusplus") }, { name: "C#", icon: iconUrl("csharp") }, { name: "Java", icon: iconUrl("openjdk") }, { name: "Node.js", icon: iconUrl("nodedotjs") }, { name: "Next.js", icon: iconUrl("nextdotjs") }, { name: "Tailwind", icon: iconUrl("tailwindcss") }, { name: "Vercel", icon: iconUrl("vercel") }, { name: "Netlify", icon: iconUrl("netlify") }, { name: "Codex", icon: iconUrl("openai") }, { name: "Claude Code", icon: iconUrl("anthropic") }, { name: "ChatGPT", icon: iconUrl("openai") }, { name: "Postman", icon: iconUrl("postman") }, { name: "Supabase", icon: iconUrl("supabase") }, { name: "Git", icon: iconUrl("git") }, { name: "GitHub", icon: iconUrl("github") }, { name: "Docker", icon: iconUrl("docker") }, { name: "MongoDB", icon: iconUrl("mongodb") }, { name: "Firebase", icon: iconUrl("firebase") }, { name: "VS Code", icon: iconUrl("visualstudiocode") }, { name: "Vite", icon: iconUrl("vite") },
];
const batmanQuotes = [
  ...
  return <>
    ...
    <main>
      <header className="header">
        <div className="batmobile-lane" aria-hidden="true"><div className="batmobile-run"><span className="batmobile-flame" /><img src="/batmobile.png" alt="" /></div></div>
      ...
      <section id="tech-stack" className="section tech-stack"><p className="label">Tech Stack</p><h2>TOOLS I&apos;M<br /><em>LEARNING.</em></h2><div className="tech-list"><div className="tech-track">{[0, 1].map((loop) => <div className="tech-set" aria-hidden={loop === 1} key={loop}>{techStack.map((tool) => <div className="tech-logo" key={tool.name}><img src={tool.icon} alt="" /><span>{tool.name}</span></div>)}</div>)}</div></div></section>
      ...
      <section id="contact" className="contact"><video className="contact-video" autoPlay loop muted playsInline preload="metadata" aria-hidden="true"><source src="/connect-background.mp4" type="video/mp4" /></video><div className="contact-overlay" aria-hidden="true" /><p className="label">Connect</p><h2>LET&apos;S CONNECT.</h2><div className="connect-grid">
        <a className="connect-card" href="mailto:Connect@bheemchauhan.com" aria-label="Send Bheem an email"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="5" width="18" height="14" rx="2" /><path d="m4 7 8 6 8-6" /></svg><span>Email</span></a>
