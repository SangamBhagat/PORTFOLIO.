...
export default function Home() {
  ...
  return <>
    ...
    <main>
      ...
      <section id="contact" className="contact"><p className="label">Connect</p><h2>LET&apos;S CONNECT.</h2><div className="connect-grid">
