...
const techStack = [
  { name: "HTML", mark: "<> ", tone: "html" }, { name: "CSS", mark: "#", tone: "css" }, { name: "JavaScript", mark: "JS", tone: "javascript" }, { name: "Python", mark: "Py", tone: "python" }, { name: "React", mark: "⚛", tone: "react" }, { name: "C++", mark: "C++", tone: "cpp" }, { name: "C#", mark: "C#", tone: "csharp" }, { name: "Java", mark: "J", tone: "java" }, { name: "Vercel", mark: "▲", tone: "vercel" }, { name: "Netlify", mark: "N", tone: "netlify" }, { name: "Codex", mark: "◈", tone: "codex" }, { name: "Claude Code", mark: "AI", tone: "claude" }, { name: "ChatGPT", mark: "◎", tone: "chatgpt" }, { name: "Antigravity", mark: "A", tone: "antigravity" }, { name: "Postman", mark: "P", tone: "postman" }, { name: "Supabase", mark: "S", tone: "supabase" },
];
const batmanQuotes = [
